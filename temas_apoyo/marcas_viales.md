...
| Tipo | Significado | ¿Se puede cruzar? |
|------|-------------|-------------------|
| Línea continua | Prohibido cruzar o pisar. | ❌ |
| Línea discontinua | Permite cambiar de carril o adelantar si es seguro. | ✅ |
| Doble línea continua | Prohibido cruzar en ambos sentidos. | ❌ |
| Línea continua junto a discontinua | Solo puedes cruzar si la discontinua está de tu lado. | ⚠️ |
| Línea de borde | Delimita el borde de la calzada. Solo en emergencia. | ⚠️ |
| Línea de carril reversible | Doble línea discontinua. El sentido puede cambiar según la señalización. | ⚠️ |
...
| Tipo | Significado |
|------|-------------|
| Línea de detención | Donde debes parar en un STOP o semáforo. |
| Paso de peatones (zebra) | Prioridad para los peatones. |
| Línea de ceda el paso | Triángulos en el suelo. Reduce la velocidad y prepárate para ceder. |
...
- **Flechas de selección de carril**: Te obligan a seguir la dirección indicada.
- **Flechas de salida o incorporación**: Indican desvíos o entradas a la vía.
- **Símbolos de bicicleta**: Carril exclusivo para ciclistas.
- **Símbolos de bus/taxi**: Carril reservado para transporte público.
...
- **Marcas amarillas en línea**: Prohibido estacionar.
- **Cuadrícula amarilla**: Prohibido detenerse dentro del área (cruces congestionados).
- **Marcas azules**: Zona de estacionamiento regulado (zona azul).
- **Marcas de estacionamiento**: Delimitan plazas de aparcamiento.
- **Marcas de carga y descarga**: Reservan espacio para vehículos de reparto.
- **Marcas de parada de bus**: Zona reservada para autobuses.
- **Marcas de zona escolar**: Indican proximidad a colegios, extrema precaución.
- **Marcas de reducción de velocidad**: Líneas transversales que se acercan entre sí.
...
- **Marcas de carril reversible**: Doble línea discontinua, sentido variable.
- **Marcas de carril bus-VAO**: Carril compartido para bus y VAO.
- **Marcas de carril bici**: Carril exclusivo para bicicletas.
- **Marcas de carril taxi**: Carril exclusivo para taxis.
- **Marcas de carril de aceleración/deceleración**: Indican carriles para incorporarse o salir de la vía.
...
| Marcas | Prohibido | Permitido | Solo en casos |
|--------|-----------|-----------|---------------|
| Línea continua | ✅ | ❌ |  |
| Línea discontinua | ❌ | ✅ |  |
| Doble continua | ✅ | ❌ |  |
| Continua + discontinua | ⚠️ | ⚠️ | Solo si la discontinua está de tu lado |
| Amarillas | ✅ | ❌ |  |
| Azules | ❌ | ✅ | Solo con ticket |
